define(["react"]
	...
	var PRODUCTS = [
		{category: '苹果', price: '¥49.99', stocked: true, name: 'iPhone6'},
		{category: '苹果', price: '¥9.99', stocked: true, name: 'iPhone6plus'},
		{category: '苹果', price: '¥29.99', stocked: false, name: 'iPhone6s'},
		{category: '栗子', price: '¥99.99', stocked: true, name: 'iPod Touch'},
		{category: '栗子', price: '¥399.99', stocked: false, name: 'iPhone 5'},
		{category: '栗子', price: '¥199.99', stocked: true, name: 'Nexus 7'}
	];
