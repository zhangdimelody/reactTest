define(['react','reactRouter','js/tab-view']
	    ...
	    return (
	      React.createElement("div", {className: "app"}, 
	        React.createElement("nav", null, 
	          ...
	          React.createElement("a", {href: "#"}), React.createElement(Link, {to: "tabview"}, "电影")
	        ), 
	...
	var routes = (
	  React.createElement(Route, {handler: App}, 
	    ...
	    React.createElement(Route, {name: "tabview", handler: TabView}), 
	    React.createElement(Redirect, {to: "tabview"})
	  )
	);
	...
	Router.run(routes, Router.HashLocation, function(Root){
	  React.render(React.createElement(Root, null), document.getElementById("content_wrap"));
	});
